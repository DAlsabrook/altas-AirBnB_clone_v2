...
def create_tables():
    ...
    place_0 = Place(user_id=user.id, city_id=city.id, name="Lake House")
    place_0.save()
    place_1 = Place(user_id=user.id, city_id=city.id, name="Riverside House")
    place_1.save()
    place_2 = Place(user_id=user.id, city_id=city.id, name="Midtown house")
    place_2.save()
    place_3 = Place(user_id=user.id, city_id=city.id, name="Downtown loft")
    place_3.save()
    # creation of 3 various Amenity
    amenity_0 = Amenity(name="wifi")
    amenity_0.save()
    amenity_1 = Amenity(name="tv")
    amenity_1.save()
    amenity_2 = Amenity(name="patio")
    amenity_2.save()
    amenity_3 = Amenity(name="food")
    amenity_3.save()
